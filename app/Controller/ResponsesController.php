...
class ResponsesController extends AppController {
	...
	public function add() {
		...
		$tasktypes = $this->Response->Tasktype->find( 'list' );
		$rsets     = $this->Response->Rset->find( 'list' );
		$labs      = $this->Response->Lab->find( 'list' );
		$users     = $this->Response->User->find( 'list' );
		$this->set( compact( 'tasktypes', 'rsets', 'labs', 'users' ) );
	}
