<div class="audios index">
	...
	<tr>
		<td><?php echo h($audio['Audio']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($audio['Asset']['id'], array('controller' => 'assets', 'action' => 'view', $audio['Asset']['id'])); ?>
		</td>
		<td><?php echo h($audio['Audio']['format']); ?>&nbsp;</td>
		<td><?php echo h($audio['Audio']['length']); ?>&nbsp;</td>
		<td><?php echo h($audio['Audio']['license']); ?>&nbsp;</td>
		<td><?php echo h($audio['Audio']['data']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $audio['Audio']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $audio['Audio']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $audio['Audio']['id']), null, __('Are you sure you want to delete # %s?', $audio['Audio']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
