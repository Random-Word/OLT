...
$controls_array = array( "buttons" => array( array( "action"  => "refresh",
                                             ...
                                             array( "action"  => "jumpList",
                                                    ...
                                                    "options" => array(
	                                                    ...
	                                                    "stop"     => $video_1['properties']['duration'], // time to stop incrementing
	                                                    "label"    => null )
...
$video_1['properties']['intervalize'] = $interval_value; // todo: this kind of thing should probably be done in the controller, eventually, by inferring the need from the schema
$video_1['properties']['on'] = 'e.intervalChange';
$video_1['properties']['do'] = 'local.loadInterval';
...
for ($i=0; $i<ceil($video_1['properties']['duration'] / 10); $i++) {
							...
							<div class="small-12 columns">
								<ul class="olt-heading menu">
									...
									<li class="heading toggler right">
										<a class="right-off-canvas-toggle" href="#" ><span class="small note-text">Choose Possible Operational Definition&nbsp;&rsaquo;&rsaquo;</span></a>
									</li>
								</ul>
							</div>
						</div>
