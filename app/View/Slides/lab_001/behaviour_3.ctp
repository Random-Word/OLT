...
$controls_array = array( "buttons" => array( array( "action"  => "refresh",
                                             ...
                                             array( "action"  => "jumpList",
                                                    ...
                                                    "options" => array(
	                                                    ...
	                                                    "stop"     => $video_3['properties']['duration'], // time to stop incrementing
	                                                    "label"    => null )
...
$video_3['properties']['intervalize'] = $interval_value; // todo: this kind of thing should probably be done in the controller, eventually, by inferring the need from the schema
$video_3['properties']['on'] = 'e.intervalChange';
$video_3['properties']['do'] = 'local.loadInterval';
...
for ($i=0; $i<ceil($video_3['properties']['duration'] / 10); $i++) {
